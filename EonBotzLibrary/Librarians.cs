...
namespace EonBotzLibrary
{
    public class Librarians
    {
        ...
        public void CREATE_DATA()
        {
            ...
            using (cmd = new MySqlCommand("INSERT INTO librarians(Lastname,Firstname,Middlename,Age,Dateofbirth,Placeofbirth,ContactNo,Gender,MaritalStatus,Citizenship,Religion,Address)VALUES(" +
        ...
        public void UPDATE_DATA()
        {
            ...
            using (cmd = new MySqlCommand("update librarians set lastname=@lname, firstname=@fname, middlename=@mname, age=@age, dateofbirth=@dob, placeofbirth=@pob," +
                "contactno=@contact,gender=@gender, maritalstatus=@marital, citizenship=@citizen, religion=@religion, address=@address WHERE librarianId=@id", conn))
            {
        ...
        public void VIEW_DATA()
        {
            ...
            dt.Clear();
            using (cmd = new MySqlCommand("SELECT * from librarians", conn))
            {
        ...
        public void PassData()
        {
            ...
            using (cmd = new MySqlCommand("SELECT * FROM librarians WHERE librarianId LIKE @id", conn))
            {
