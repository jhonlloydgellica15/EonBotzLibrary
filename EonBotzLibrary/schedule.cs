...
namespace EonBotzLibrary
{
    public class schedule
    {
        ...
        public void times()
        {
            ...
            cmd = new MySqlCommand(" select timeend from schedule where roomid = '" + roomid + "'and date regexp '[" + date + "]' and timestart between'" + timeStart + "'and timestart   <='" + timeEnd + "' and timeend >='" + timeStart + "'and timeend <='" + timeEnd + "'", conn);
